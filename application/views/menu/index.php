                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($menu as $m) : ?>
                                        <tr>
                                            ...
                                            <td><?= $m['menu']; ?></td>
                                            <td>
                                                <a href="" class="badge badge-sm badge-success" data-toggle="modal" data-target="#modal<?php echo $m['id']; ?>">Edit</a>
                ...
                <!-- modal Edit Menu -->
                <?php foreach ($menu as $m) : ?>
                    <div class="modal fade" id="modal<?php echo $m['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Edit Nama Menu</h5>
